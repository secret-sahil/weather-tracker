...
def getWeather(canvas):
    ...
    min_temprature = int(json_data['main']['temp_min'] - 273.15)
    max_temprature = int(json_data['main']['temp_max'] - 273.15)
    ...
    final_data = "\n" + "Min Temp: " + str(min_temprature) + "°C" + "\n" + "Max Temp: " + str(max_temprature) + "°C" + "\n" + "Pressure: " + str(
